...
api = os.path.join(parent, 'api')
api4app = os.path.join(parent, 'api/api4app')   # Get the directory for framework
...
# print("sys.path.append(api4app): ", sys.path.append(api4app))
# print("sys.path.append(api4app): ", api4app)
