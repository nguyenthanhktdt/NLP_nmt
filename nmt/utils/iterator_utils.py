...
def get_infer_iterator(src_dataset,
  ...
  batched_iter = batched_dataset.make_initializable_iterator() # source
  # batched_iter = tf.compat.v1.data.make_initializable_iterator(batched_dataset) # Thanh sua tf.compat.v1.data.make_initializable_iterator(dataset)
