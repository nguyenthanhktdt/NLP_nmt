...
def _create_attention_images_summary(final_context_state):
  ...
  # attention_summary = tf.compat.v1.summary.image("attention_images", attention_images) # Thanh
  attention_summary = tf.summary.image("attention_images", attention_images) # source
